...
import { agricole, User } from '../adminPages/list-of-users/list-of-users.component';
...
public agricole(): Observable<agricole[]> {
  return this.http.get<agricole[]>('localhost:5000/api/admin/agricoles');
}
//////*******************Authorisation******************************** */
...
public authorisation(): Observable<User[]> {
